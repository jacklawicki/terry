class CashesController < ApplicationController
  ...
  private
    ...
    def correct_user
      @cash = current_user.Cash.find_by(id: params[:id])
      redirect_to cashes_path, notice: "Not authorized to edit this Asset" if @cash.nil?
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def cash_params
      params.require(:cash).permit(:description, :value)
    end
